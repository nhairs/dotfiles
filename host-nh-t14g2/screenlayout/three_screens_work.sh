...
if xrandr | grep -q "DisplayPort-2 connected" ; then
    xrandr --output eDP --primary --mode 1920x1080 --pos 1920x1080 --rotate normal \
        --output HDMI-A-0 --off \
    ...
    xrandr --output eDP --primary --mode 1920x1080 --pos 1920x1080 --rotate normal \
        ...
        --output DisplayPort-4 --mode 1920x1080 --pos 1920x0 --rotate normal \
        --output DisplayPort-5 --mode 1920x1080 --pos 0x0 --rotate normal \
        --output DisplayPort-6 --off
fi
